...
import { Command, CommandGroup, CommandItem, CommandList } from "@/core/components/ui/command.tsx";
...
interface MultipleSelectorProps {
  ...
  /** Custom message for creatable items */
  createMessage?: (value: string) => string | null;
}
...
const MultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
  (
    ...
    const CreatableItem = () => {
      ...
      // Add email validation check here
      const message = createMessage?.(inputValue);
      // If createMessage returns null (invalid email) or there's no message, don't show the item
      ...
      const Item = (
        ...
        >
          {createMessage ? createMessage(inputValue) : `Create "${inputValue}"`}
        </CommandItem>
      );
