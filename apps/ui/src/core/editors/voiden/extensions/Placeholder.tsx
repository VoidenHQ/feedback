        ...
        props: {
          decorations: ({ doc, selection }) => {
            ...
            const isValidNode = this.options.considerAnyAsEmpty
              ...
              doc.type.contentMatch.defaultType?.name;
            const isEmptyDoc =
            ...
            doc.descendants((node, pos) => {
              const hasAnchor = anchor >= pos && anchor <= pos + (node?.nodeSize ?? 0);
              ...
              if (
                ...
                const decoration = Decoration.node(pos, pos + (node?.nodeSize ?? 0), {
                  class: classes.join(" "),
                  "data-placeholder":
