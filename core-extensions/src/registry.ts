 ...
 * Generated on: 2025-11-16T16:59:58.051Z
 */
...
export const coreExtensions: ExtensionMetadata[] = [
  {
    ...
    priority: 10,
    readme:
      "Complete REST API testing extension with HTTP methods, headers, query params, body, and response visualization. Built on the new SDK pipeline architecture.",
    capabilities: {
      blocks: {
        owns: [
          "method",
      ...
      slashCommands: {
        groups: [
          {
            name: "REST API",
            commands: ["Insert request block", "Insert headers table", "Insert query parameters", "Insert request body"],
          },
        ],
      },
    },
  ...
  },
  {
    ...
    name: "Voiden GraphQL",
    description:
      "GraphQL client with schema importer for building queries through a dedicated UI or editing manually. Supports queries, mutations, subscriptions with variables. Leverages voiden-rest-api for request execution",
    version: "1.0.0",
    author: "Voiden Team",
    enabled: true,
    priority: 15,
    readme:
      "GraphQL extension with schema file importer and visual query builder UI. Select operations and fields from your schema or write queries manually. Supports queries, mutations, and subscriptions with variables. Depends on voiden-rest-api for request execution.",
    capabilities: {
      blocks: {
        owns: [
          "gqlquery",
        ...
        allowExtensions: true,
        description: "Owns 3 block types for GraphQL query, variables, and subscription events",
      },
      requestPipeline: {
        buildHandler: true,
        responseHandler: true,
      ...
      slashCommands: {
        groups: [
          {
            name: "graphql",
            commands: ["Insert GraphQL Query", "Insert GraphQL Variables"],
          },
        ],
      },
    },
    ...
    features: [
      ...
      "Real-time subscription events tracking",
    ],
    type: "core",
  },
  {
    ...
    priority: 20,
    readme:
      "Simple Assertions provides an easy way to write and execute assertions against HTTP responses. Use the `/assertions` slash command to insert an assertion table, then write your test cases using a simple two-column format: 'Description | Field | Operator' and 'Expected Value'. Assertion results are displayed as a sub-panel in the response tab.",
    capabilities: {
      blocks: {
        owns: ["assertions-table"],
  ...
  },
  {
    ...
    description:
      "Advanced authentication support for HTTP/REST APIs including Bearer Token, Basic Auth, API Key, OAuth 1.0/2.0, Digest, AWS Signature, and more",
    version: "1.0.0",
    author: "Voiden Team",
    enabled: true,
    priority: 20,
  ...
  },
  {
    ...
    priority: 30,
    readme:
      "Generates fake data using Faker.js in your HTTP requests. Use {{$faker.person.firstName()}} or {{$faker.number.int({\"min\":1,\"max\":10})}} syntax in headers, query params, path params, and request bodies.",
    capabilities: {
      pipeline: {
        hooks: ["pre-send"],
      },
  ...
  },
  {
    ...
    description:
      "Live preview and rendering for Markdown files with full GitHub Flavored Markdown (GFM) support including tables, syntax highlighting, task lists, and strikethrough formatting",
    version: "1.0.0",
    author: "Voiden Team",
    enabled: true,
    priority: 40,
  ...
  },
  {
    ...
    description:
      "Seamlessly migrate from OpenAPI by importing v3.0 collections and converting them to native Voiden request files with full support for nested folders, environment variables, headers, auth, and all request body types",
    version: "1.0.0",
    author: "Voiden Team",
    enabled: true,
    priority: 50,
    ...
    capabilities: {
      ...
      fileSystem: {
        operations: ["create-directory", "write-file"],
  ...
  },
  {
    ...
    description:
      "Seamlessly migrate from Postman by importing v2.1 collections and automatically converting them to native Voiden request files with full support for nested folders, environment variables, headers, auth, and all request body types",
    version: "1.0.0",
    author: "Voiden Team",
    enabled: true,
    priority: 50,
    ...
    capabilities: {
      ...
      slashCommands: {
        groups: [
          {
            name: "Sockets",
            commands: ["Insert WebSocket block", "Insert gRPC socket block"],
          },
