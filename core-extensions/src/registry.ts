...
export const coreExtensions: ExtensionMetadata[] = [
  ...
  },
  {
    ...
    "enabled": true,
    "priority": 30,
    "readme": "Generates fake data using Faker.js in your HTTP requests. Use {{$faker.person.firstName()}} syntax in headers, query params, path params, and request bodies.",
    "capabilities": {
      "pipeline": {
        "hooks": [
          "pre-send"
